    ...
    for l2 in range(1,5):
        for l3 in range(1,5):
            ...
            model = Sequential([
                ...
                Dense(Hlayer1 , kernel_regularizer=regularizers.l2(0.0005) ,kernel_initializer='random_uniform'),

                Activation('relu'),
                Dropout(0.2),
                Dense(Hlayer2, kernel_regularizer=regularizers.l2(0.0005) , kernel_initializer='random_uniform'),

                Activation('relu'),
                Dropout(0.2),
                Dense(Hlayer3,  kernel_regularizer=regularizers.l2(0.0005) ,kernel_initializer='random_uniform'),
                Activation('relu'),
            ...
            # print y
            diff = y_t_class[1] - y
            meanerror = np.sum(abs(y_t_class[1] - y)) / float(y.shape[0])*2

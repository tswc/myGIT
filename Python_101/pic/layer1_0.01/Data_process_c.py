    ...
    for l2 in range(4,5):
        for l3 in range(1,5):
            ...
            model = Sequential([
                ...
                Dense(Hlayer1, kernel_regularizer=regularizers.l1_l2(aa), kernel_initializer='random_uniform'),

                Activation('relu'),

                Dense(Hlayer2, kernel_regularizer=regularizers.l1(0), kernel_initializer='random_uniform'),

                Activation('relu'),

                Dense(Hlayer3, kernel_regularizer=regularizers.l1(0), kernel_initializer='random_uniform'),
                Activation('relu'),


                Dense(51, kernel_regularizer=regularizers.l1(0), kernel_initializer='random_uniform'),
                Activation('softmax')
                ])

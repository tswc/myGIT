    ...
    for l2 in range(1,5):
        for l3 in range(1,5):
            ...
            model = Sequential([
                ...
                Dense(Hlayer1, kernel_initializer='random_uniform'),

                Activation('relu'),
                # Dropout(0,2),
                Dense(Hlayer2,  kernel_initializer='random_uniform'),

                Activation('relu'),
                # Dropout(0, 2),
                Dense(Hlayer3,  kernel_initializer='random_uniform'),
                Activation('relu'),
                # Dropout(0, 2),
            ...
            plt.savefig(r'C:\Users\TSWC\Google Drive\FA\Python_101\PIC2\2c_noregu\figure' + str(l1) + str(l2) + str(l3)+'.png')

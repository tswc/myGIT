...
x_t, y_t,yIR = tj.data2x_y_logic(test, n_range=np.arange(0, 100.5, 0.5))
print x_t.shape

x_train, x_test = tj.Sep_TT(x_t, 0.2)
y_train, y_test = tj.Sep_TT(y_t, 0.2)
# y_train = tj.class2sep(y_train, 50)
# y_test = tj.class2sep(y_test, 50)
print y_test.shape
lamda1 = 0
lamda2 = 0
lamda3 = 0
    ...
    for l2 in range(1,5):
        for l3 in range(1,5):
            ...
            model = Sequential([
                ...
                Dense(Hlayer1, kernel_regularizer=regularizers.l1_l2(0), kernel_initializer='random_uniform'),
